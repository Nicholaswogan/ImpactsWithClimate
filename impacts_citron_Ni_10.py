...
def citron_imp_23_00(restart_from_file=False, T_surf_guess=300):
    ...
    params['outfile'] = "results/evolution/citron_Ni_10/imp_23_00"
    params['T_guess'] = 280
...
def citron_imp_23_10(restart_from_file=False, T_surf_guess=300):
    ...
    params['outfile'] = "results/evolution/citron_Ni_10/imp_23_10"
    params['T_guess'] = 280
    iron = citron_interp.nominal_iron_interpolator()
    params['Fe_react_frac'] = iron(params['init']['M_i'])
    return params
...
def citron_imp_23_20(restart_from_file=False, T_surf_guess=300):
    ...
    params['outfile'] = "results/evolution/citron_Ni_10/imp_23_20"
    params['T_guess'] = 290
    iron = citron_interp.nominal_iron_interpolator()
    params['Fe_react_frac'] = iron(params['init']['M_i'])
    return params
...
def citron_imp_23_30(restart_from_file=False, T_surf_guess=300):
    ...
    params['outfile'] = "results/evolution/citron_Ni_10/imp_23_30"
    params['T_guess'] = 300
    iron = citron_interp.nominal_iron_interpolator()
    params['Fe_react_frac'] = iron(params['init']['M_i'])
    return params
...
def citron_imp_23_40(restart_from_file=False, T_surf_guess=300):
    ...
    params['outfile'] = "results/evolution/citron_Ni_10/imp_23_40"
    params['T_guess'] = 300
    iron = citron_interp.nominal_iron_interpolator()
    params['Fe_react_frac'] = iron(params['init']['M_i'])
    return params
...
def citron_imp_23_50(restart_from_file=False, T_surf_guess=300):
    ...
    params['outfile'] = "results/evolution/citron_Ni_10/imp_23_50"
    params['T_guess'] = 300
    iron = citron_interp.nominal_iron_interpolator()
    params['Fe_react_frac'] = iron(params['init']['M_i'])
    return params
...
def citron_imp_23_60(restart_from_file=False, T_surf_guess=300):
    ...
    params['outfile'] = "results/evolution/citron_Ni_10/imp_23_60"
    params['T_guess'] = 310
    iron = citron_interp.nominal_iron_interpolator()
    params['Fe_react_frac'] = iron(params['init']['M_i'])
    return params
...
def citron_imp_23_70(restart_from_file=False, T_surf_guess=300):
    ...
    params['outfile'] = "results/evolution/citron_Ni_10/imp_23_70"
    params['T_guess'] = 310
    iron = citron_interp.nominal_iron_interpolator()
    params['Fe_react_frac'] = iron(params['init']['M_i'])
    return params
...
def citron_imp_23_80(restart_from_file=False, T_surf_guess=300):
    ...
    params['outfile'] = "results/evolution/citron_Ni_10/imp_23_80"
    params['T_guess'] = 310
    iron = citron_interp.nominal_iron_interpolator()
    params['Fe_react_frac'] = iron(params['init']['M_i'])
    return params
...
def citron_imp_23_90(restart_from_file=False, T_surf_guess=300):
    ...
    params['outfile'] = "results/evolution/citron_Ni_10/imp_23_90"
    params['T_guess'] = 330
    iron = citron_interp.nominal_iron_interpolator()
    params['Fe_react_frac'] = iron(params['init']['M_i'])
    params['stm_rtol'] = 1e-9
...
def citron_imp_24_00(restart_from_file=False, T_surf_guess=300):
    ...
    params['outfile'] = "results/evolution/citron_Ni_10/imp_24_00"
    params['T_guess'] = 330
    iron = citron_interp.nominal_iron_interpolator()
    params['Fe_react_frac'] = iron(params['init']['M_i'])
    return params
...
def citron_imp_24_10(restart_from_file=False, T_surf_guess=300):
    ...
    params['outfile'] = "results/evolution/citron_Ni_10/imp_24_10"
    params['T_guess'] = 330
    iron = citron_interp.nominal_iron_interpolator()
    params['Fe_react_frac'] = iron(params['init']['M_i'])
    return params
...
def citron_imp_24_20(restart_from_file=False, T_surf_guess=300):
    ...
    params['outfile'] = "results/evolution/citron_Ni_10/imp_24_20"
    params['T_guess'] = 330
    iron = citron_interp.nominal_iron_interpolator()
    params['Fe_react_frac'] = iron(params['init']['M_i'])
    return params
...
def citron_imp_24_30(restart_from_file=False, T_surf_guess=300):
    ...
    params['outfile'] = "results/evolution/citron_Ni_10/imp_24_30"
    params['T_guess'] = 330
    iron = citron_interp.nominal_iron_interpolator()
    params['Fe_react_frac'] = iron(params['init']['M_i'])
    return params
...
def citron_imp_24_40(restart_from_file=False, T_surf_guess=300):
    ...
    params['outfile'] = "results/evolution/citron_Ni_10/imp_24_40"
    params['T_guess'] = 330
    iron = citron_interp.nominal_iron_interpolator()
    params['Fe_react_frac'] = iron(params['init']['M_i'])
    return params
...
def citron_imp_24_50(restart_from_file=False, T_surf_guess=300):
    ...
    params['outfile'] = "results/evolution/citron_Ni_10/imp_24_50"
    params['T_guess'] = 330
    iron = citron_interp.nominal_iron_interpolator()
    params['Fe_react_frac'] = iron(params['init']['M_i'])
    return params
...
def citron_imp_24_60(restart_from_file=False, T_surf_guess=300):
    ...
    params['outfile'] = "results/evolution/citron_Ni_10/imp_24_60"
    params['T_guess'] = 330
    iron = citron_interp.nominal_iron_interpolator()
    params['Fe_react_frac'] = iron(params['init']['M_i'])
    return params
...
def citron_imp_24_70(restart_from_file=False, T_surf_guess=300):
    ...
    params['outfile'] = "results/evolution/citron_Ni_10/imp_24_70"
    params['T_guess'] = 340
    iron = citron_interp.nominal_iron_interpolator()
    params['Fe_react_frac'] = iron(params['init']['M_i'])
    return params
...
def citron_imp_24_80(restart_from_file=False, T_surf_guess=300):
    ...
    params['outfile'] = "results/evolution/citron_Ni_10/imp_24_80"
    params['T_guess'] = 350
    iron = citron_interp.nominal_iron_interpolator()
    params['Fe_react_frac'] = iron(params['init']['M_i'])
    return params
...
def citron_imp_24_90(restart_from_file=False, T_surf_guess=300):
    ...
    params['outfile'] = "results/evolution/citron_Ni_10/imp_24_90"
    params['T_guess'] = 360
    iron = citron_interp.nominal_iron_interpolator()
    params['Fe_react_frac'] = iron(params['init']['M_i'])
    return params
...
def citron_imp_25_10(restart_from_file=False, T_surf_guess=300):
    ...
    params['outfile'] = "results/evolution/citron_Ni_10/imp_25_10"
    params['T_guess'] = 380
    iron = citron_interp.nominal_iron_interpolator()
    params['Fe_react_frac'] = iron(params['init']['M_i'])
    return params
